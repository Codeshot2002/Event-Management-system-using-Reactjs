...
import "./Card.css";
function Card({ card_title, card_subtitle, location, date }) {
  return (
    <>
      <div class="card">
        ...
        <div className="card__title">{card_title}</div>
        <div className="card__subtitle">{card_subtitle}</div>
        ...
        <div className="card__wrapper">
          ...
          <button className="card__btn card__btn-solid">Enroll</button>
        </div>
      </div>
    </>
  );
